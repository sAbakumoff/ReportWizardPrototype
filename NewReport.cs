...
namespace ReportWizardPrototype
{
    public partial class NewReport : Form
    {
        public NewReport()
        {
            ...
            var sampleReportItem = BuildReportTypeItem("ReportWizardPrototype.Resources.rdlx.png", "Select from a range of pre-designed reports, each tailored to showcase specific features.", "Sample Report");
            ...
            tableLayoutPanel1.Controls.Add(sampleReportItem);
            ...
            tableLayoutPanel1.SetRow(sampleReportItem, 4);
            tableLayoutPanel1.SetColumn(sampleReportItem, 0);
